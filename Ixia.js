  ...
  // Sample responses based on user input
    const responses = [
      ...
      },
      {
          ...
          replies: ["Why don't scientists trust atoms? Because they make up everything!", "I told my computer I needed a break, and it said no problem — it needs one too!", "Why did the math book look sad? Because it had too many problems!", "Why was the computer cold? It left its Windows open!", "Why do programmers prefer dark mode? Because the light attracts bugs!", "What did one ocean say to the other ocean? Nothing, they just waved!", "Why did the scarecrow win an award? Because he was outstanding in his field!"]
      },
      {
          keywords: ["time", "what time is it", "current time", "clock"],
          replies: ["I'm not able to tell the time right now, but you could check your clock!", "I wish I could tell you the exact time, but maybe try looking at a watch or your phone!", "I can't provide real-time information, but checking a nearby clock might help!", "I don't have a clock built-in, but your device should have one!", "I can't access the current time, but any device with a clock can help you there!", "I'm not connected to time data, but there's always a clock somewhere nearby!"]
      },
      {
          keywords: ["date", "what's the date", "today's date", "calendar"],
          replies: ["I can't tell you today's date, but your phone or computer should be able to!", "I'm unable to provide the current date, but it should be easy to find on your device!", "I don't have the date information available, but I'd suggest checking a calendar!", "Currently, I can't provide real-time dates, but your phone or computer can!", "I'm not sure of today's date, but it's likely available on any of your devices!", "I don't have access to dates, but a calendar nearby should help!"]
      },
      {
